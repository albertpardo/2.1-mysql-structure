...
(1,'Calle Berín',17,'1','1','Barcelona','08014','España'),
...
(1,1,'GlassGlass',-1.00,-1.00,'Transparent','Marrón',45),
(2,2,'Indo One',-2.50,-2.50,'Transparent','Negro',60),
(3,2,'Indo One',-1.50,-1.75,'Oscuro','Azul',71),
(4,4,'GreenGreen',1.25,1.75,'Transparente','Verde',80),
(5,1,'GlassGlass',-3.20,-3.75,'Oscuro','Naranje',51),
(6,3,'Affledour Start',-4.20,-4.20,'Oscuro','Aluminio',80),
(7,3,'Affledour Start',-3.25,-3.25,'Transparente','Aluminio',75);
...
INSERT INTO sales_has_glasses VALUES
(1,1),
(2,2),
(3,3),
(4,4),
